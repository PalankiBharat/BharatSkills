...
| `kmm-plugin` | 6.4.3 | Battle-tested KMM migration orchestrator — 5-phase workflow with TDD, parallel agent teams, static parity analysis, verify-first Appium, enriched migration guide, integrated self-improvement |
