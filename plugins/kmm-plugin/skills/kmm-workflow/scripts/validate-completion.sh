...
PROMISES="FILE_COMPLETE|FILE_BLOCKED|TDD_COMPLETE|TDD_BLOCKED|MIGRATION_COMPLETE|MIGRATION_BLOCKED|VERIFY_PASS|VERIFY_FAIL|DEBUG_COMPLETE|DEBUG_BLOCKED|UI_COMPLETE|UI_BLOCKED|AUDIT_COMPLETE|AUDIT_BLOCKED|REQUIRES_APPROVAL|PLAN_ANALYSIS"
